...
## [1.7.2](https://github.com/soerenschneider/acmevault/compare/v1.13.1...v1.7.2) (2023-12-26)
...
* Add metric for errors retrieving aws credentials ([a17db0a](https://github.com/soerenschneider/acmevault/commit/a17db0a0dadc2ed2cb6597876f7b45fa65d1ff68))
...
* Allow writing data as PEM file ([5678f14](https://github.com/soerenschneider/acmevault/commit/5678f14cc0380d9621dd06dfec4f957c8a8b9af1))
...
* Better validation ([06fec46](https://github.com/soerenschneider/acmevault/commit/06fec462ccc9bd48db8c69e99970a4b0057659c3))
* domain format ([#108](https://github.com/soerenschneider/acmevault/issues/108)) ([25f0779](https://github.com/soerenschneider/acmevault/commit/25f0779bf921900280ad353f08f59182ba39d9ca))
* enable loading wrapped token from disk ([d07494c](https://github.com/soerenschneider/acmevault/commit/d07494c41295cfedaee4481aea00084cbbdbf792))
* Enable separation for reading private keys and pub cert data ([413e281](https://github.com/soerenschneider/acmevault/commit/413e281ff6c3208ea0574b9ee8b0a5c05817a5ab))
...
* print version information in log ([19c9788](https://github.com/soerenschneider/acmevault/commit/19c97887bf5d91f7d5daa849918e3059ae8953db))
* support for KV2 secret engine ([d3d9337](https://github.com/soerenschneider/acmevault/commit/d3d93379782a6eabb745504ef8ba60921805475c))
* Support for response wrapped secret_ids ([#79](https://github.com/soerenschneider/acmevault/issues/79)) ([8c1c29d](https://github.com/soerenschneider/acmevault/commit/8c1c29d2825d8726ee58153fd7340c08111bc5ae))
...
* Actually validate config for server ([6d9b969](https://github.com/soerenschneider/acmevault/commit/6d9b96992e477fa103952daedb2b3104d962717b))
...
* Also write metrics in case of no error ([c6b28fb](https://github.com/soerenschneider/acmevault/commit/c6b28fb055f980abc35cc1a8728273e0e563b7f4))
* always write cert expiry metrics ([33535b7](https://github.com/soerenschneider/acmevault/commit/33535b799944a56df16a8313dcd3260b88857ae5))
* Always write prom metrics before exit ([c254b0c](https://github.com/soerenschneider/acmevault/commit/c254b0c802692376dc206dd1ffcd073ae9554851))
* authenticate before reading acme account from storage ([d6d0324](https://github.com/soerenschneider/acmevault/commit/d6d0324cf837de3ba9f087ddf06de0c87309bc76))
...
* check if files are configured before trying to write ([496b116](https://github.com/soerenschneider/acmevault/commit/496b116a75f480b27e09374200badb0f4c15ac61))
* Check if pathPrefix is empty ([28cc23f](https://github.com/soerenschneider/acmevault/commit/28cc23fd016081486d053c1af1f9a491a901e026))
...
* **deps:** bump github.com/aws/aws-sdk-go-v2/config ([#381](https://github.com/soerenschneider/acmevault/issues/381)) ([222e2f3](https://github.com/soerenschneider/acmevault/commit/222e2f3e95b3cd2ad62452e55005b9084b25101a))
...
* do not include issuer cert in pem ([ef0b324](https://github.com/soerenschneider/acmevault/commit/ef0b3246edacf0d846777d877c5cf24e865bc86d))
* eliminate possible newline after the secret_id ([e7452b9](https://github.com/soerenschneider/acmevault/commit/e7452b9168f0b52e07cf401f4de5a795f3a74693))
...
* fix incorrect check using the wrong predicate ([1b9f667](https://github.com/soerenschneider/acmevault/commit/1b9f6672a10c5ef632a3a9ff0173423578915c35))
* fix json key name ([1c234e1](https://github.com/soerenschneider/acmevault/commit/1c234e1fd17139550bca47e39518459eabd3769a))
* fix log output when printing config ([89751cb](https://github.com/soerenschneider/acmevault/commit/89751cbf3e08abe4c040cf7b8a069f4b9a6f9b72))
...
* increase privacy of not recycling old private keys ([e2cbad8](https://github.com/soerenschneider/acmevault/commit/e2cbad89b4fb08c260d3cc3b16d1c0a4e33d633d))
* Remove role_id prefix from domain ([74006b7](https://github.com/soerenschneider/acmevault/commit/74006b77c5df5f7176ef3cac7b1743252edfb69f))


### Miscellaneous Chores

* release 1.7.1 ([615d63a](https://github.com/soerenschneider/acmevault/commit/615d63a159f7160ffdc88d70b81e0c23020a4a38))
* release 1.7.2 ([ee42f8f](https://github.com/soerenschneider/acmevault/commit/ee42f8f21091251f6bcce38a90399f23892688d3))
